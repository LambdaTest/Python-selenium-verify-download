# Run Python Selenium Verify Download Tests on TestMu AI (Formerly LambdaTest)
...
If you want to verify file download in automation test in Python-selenium on TestMu AI (Formerly TestMu AI (Formerly LambdaTest)), you can follow the below steps.
